...
public class UtenteServiceImpl implements UtenteService {
	...
	@Override
	public int quantiUtentiAdmin() {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		
		try {
			utenteDAO.setEntityManager(entityManager);
			
			return utenteDAO.howManyUtenteAreAdmin();
	...
	@Override
	public List<Utente> utentiMeseEAnno(int mese, int anno) throws Exception {
		EntityManager entityManager = EntityManagerUtil.getEntityManager();
		try {
			utenteDAO.setEntityManager(entityManager);
			
			return utenteDAO.usersByMonthAndYear(mese, anno);
