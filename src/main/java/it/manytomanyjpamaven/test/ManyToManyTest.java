...
//			testQuantiAdmin(utenteServiceInstance);
			
//			testUserMeseEAnno(utenteServiceInstance);
			
//			testDescrizioneRuolo(ruoloServiceInstance);
	...
	private static void testQuantiAdmin(UtenteService utenteServiceInstance) {
		System.out.println(".......TEST INIZIO............");

		int count = 0;

		count = utenteServiceInstance.quantiUtentiAdmin();
	...
	private static void testUserMeseEAnno(UtenteService utenteServiceInstance)  throws Exception{
		System.out.println(".......TEST INIZIO............");
		
		List<Utente> result = new ArrayList<>();
		
		utenteServiceInstance.utentiMeseEAnno(02,2020);
	...
	private static void testDescrizioneRuolo(RuoloService ruoloServiceInstance)  throws Exception{
		System.out.println(".......TEST INIZIO............");
		
		List<String> result = new ArrayList<>();
		
		result = ruoloServiceInstance.descrizioneRuoloConUtente();
